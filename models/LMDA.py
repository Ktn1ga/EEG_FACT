...
-----------------------------------------------------
Model Name:         LMDA
Repository URL:     https://github.com/MiaoZhengQing/LMDA-Code
Original Paper:     Zhengqing Miao, Meirong Zhao, Xin Zhang, Dong Ming,
                    ...
                    NeuroImage,Volume 276,2023,120209,
-----------------------------------------------------
"""
...
def main():
    ...
    model = LMDA(chans=22, samples=1000, num_classes=4, depth=9, kernel=75, channel_depth1=24, channel_depth2=7,ave_depth=1, avepool=25)
    out = model(input) # , coarseFatures, fineFatures, fusionFeature, eeg_out, tcn_out, fusionDecision, attention_scores = model(input)
    print('===============================================================')
    print('out', out.shape)
    print('model', model)
    summary(model=model, input_size=(1,channels,samples), device="cpu")
